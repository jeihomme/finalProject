...
<h4><a href="/advertise/list" id="memberCk" href="adsNo">리스트</a>  /  <a href="/advertise/adscate" id="memberCk" href="adsNo"><input type="hidden" value="1"/>맴버</a>   /   <a href="/advertise/adscateCol" id="collaboration" href="adsNo"><input type="hidden" value="2"/>콜라보</a></h4>
