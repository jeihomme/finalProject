...
<form>
<h4><a href="/advertise/adscate" id="memberCk" href="adsNo"><input type="hidden" id="member" value="1">맴버</a>   /   <a href="/advertise/adscateCol" id="collaboration" href="adsNo"> <input type="hidden" id="collabo" value="2"/>콜라보</a></h4>
...
// 			var mem = data.map.list;
			...
			$newadvertiseView = $(
					     ...
					     +"</div></div>"
					     +"<audio controls class='modal-music'><source type='audio/ogg'><source type='audio/mpeg'></audio><button type='button' id='adsUpdate'>수정</button><button type='button' id='close' class='btn btn-default'>Close</button>"
					      );
