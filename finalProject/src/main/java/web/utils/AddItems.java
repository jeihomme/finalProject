...
public class AddItems {
	...
	//	pageCount == 10
	//	listCount == 10
	public AddItems(int totalCount) {
	...
	//	pageCount == 10
	//	listCount == 10
	public AddItems(int totalCount, int curPage) {
		this.setTotalCount(totalCount);
	...
	//	pageCount == 10
	public AddItems(int totalCount, int curPage, int listCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
	...
	public AddItems(int totalCount, int curPage, int listCount, int pageCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
		this.setListCount(listCount);
	...
	private void makePaging() {
		...
		if(listCount == 0)	setListCount(12); //한 화면에 보이는 게시글수 기본값(10) 세팅
